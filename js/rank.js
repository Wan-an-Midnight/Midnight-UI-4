 ...
 function rank_climb(){
	...
	document.getElementById("ranking-go-none").style.display = "none";
	document.getElementById("ranking-keep-none").style.display = "none";
	document.getElementById("ranking-tool-none").style.display = "none";
 }
 function rank_go(){
 	//document.getElementById("rank-list-all").className = "rank-button-befor";
 	document.getElementById("rank-list-climb").className = "rank-button-befor";
	...
	document.getElementById("ranking-climb-none").style.display = "none";
